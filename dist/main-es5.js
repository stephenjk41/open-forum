        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DashboardService = /** @class */ (function () {
                function DashboardService(db, afAuth, auth) {
                    ...
                    this.auth.user$.subscribe(function (user) {
                        _this.cUser.uid = user.uid;
                        _this.cUser.email = user.email;
                        _this.cUser.displayName = user.displayName;
                    });
                }
                DashboardService.prototype.getQuestionsList = function () {
                    ...
                    this.questionsRef = this.db.collection("questions", function (ref) { return ref.where('userId', '==', _this.cUser.uid); });
